...
const translations: Record<Lang, Dict> = {
  eu: {
    ...
    "e2.desc": "Eternity II puzlearen erronka: ondoko piezen ertzak bat etorri behar dira. Inork ez du jatorrizko 16×16 taula ebatzi — ez dago soluziorik. Zuk lortuko duzu?",
    "e2.solveRateLabel": "Ebatzi duen jokalarien kopurua:",
    "e2.rotate": "Biratu (R)",
    "e2.new": "Taula berria",
    "e2.reset": "Berrasi",
    "e2.pieces": "Piezak",
  ...
  es: {
    ...
    "e2.desc": "El reto del Eternity II: haz coincidir los bordes de las piezas vecinas. Nadie ha resuelto el tablero original de 16×16 — no existe solución. ¿Conseguirás tú?",
    "e2.solveRateLabel": "Jugadores que lo resuelven:",
    "e2.rotate": "Rotar (R)",
  ...
  en: {
    ...
    "e2.desc": "The Eternity II challenge: match the edges of neighbouring pieces. Nobody has solved the original 16×16 board — there is no known solution. Will you be the one?",
    "e2.solveRateLabel": "Players who solve it:",
    "e2.rotate": "Rotate (R)",
    "e2.new": "New board",
    "e2.reset": "Reset",
    "e2.pieces": "Pieces",
