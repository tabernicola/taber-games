...
const translations: Record<Lang, Dict> = {
  eu: {
    ...
    "tutorial.tabersquare.step1": "Ongi etorri The Taber Square-ra! Hau 6×6ko joko-taula da eta blokeatutako 7 gelaxka ditu. Zure helburua pieza guztiak hutsik dauden lekuetan sartzea da.",
    "tutorial.tabersquare.step2": "Hona hemen taularen barruan jarri behar dituzun 9 piezak. Haien gainean klik eginez hautatzen dira. Saiatu L gorria hautatzen!",
    "tutorial.tabersquare.step3": "Aukeratutako pieza biratu eta irauli dezakezu hobeto egokitzeko. Erabili biratu eta irauli botoiak (edo 'R' eta 'F' teklak). Probatu!",
    "tutorial.tabersquare.step4": "Jokoaren helburua pieza guztiak taularen barruan jartzea da. Jarri hautatutako pieza taulako gelaxka huts batean klik eginez edo arrastatuz.",
    "tutorial.tabersquare.finish": "Bikain! Jokatzeko prest zaude. Bete taula ahalik eta denbora laburrenean!",
    "tutorial.tabersquare.gotIt": "Ulertuta",
    "tutorial.tabersquare.playNow": "Jolastu!",
    ...
    "e2.tutorial.interactive.step1": "Ongi etorri Taber's Eternity-ra! Hauxe da joko-taula. Zure helburua pieza guztiak kokatu eta ertz guztiak bat etortzea da.",
    "e2.tutorial.interactive.step2": "Hona hemen taulan kokatu behar dituzun piezak. Haien gainean klik eginez hautatzen dira, eta 'Biratu' botoiarekin edo 'R' teklarekin biratu ditzakezu.",
    "e2.tutorial.interactive.step3": "Hasi ertzetik! Pieza horiek ertz gris bat daukate (kanpoaldekoa). Egin klik haietako batean eta jarri taulako ertz huts batean.",
    "e2.tutorial.interactive.step4": "Oso ondo! Orain ulertu behar duzu nola funtzionatzen duten ertzak: pieza bat kokatu behar duzu non bere ertzak alboko piezen ertzekin bat datozen (kolore berdina).",
    "e2.tutorial.interactive.step5": "Bikain! Pulsa gelaxka huts bat taulan pieza hautagaiak ikusteko (berdez nabarmenduko dira). Helburua taula osoa betetzea da!",
  ...
  es: {
    ...
    "tutorial.tabersquare.step1": "¡Bienvenido a The Taber Square! Este es el tablero de juego (6×6) y contiene 7 casillas bloqueadas. Tu objetivo será colocar todas las piezas en el espacio libre.",
    "tutorial.tabersquare.step2": "Estas son las 9 fichas que debes colocar dentro del tablero. Se seleccionan pinchando sobre ellas. ¡Prueba a seleccionar la L roja!",
    "tutorial.tabersquare.step3": "Puedes rotar y voltear la pieza seleccionada para que encaje mejor. Usa los botones de rotar y voltear (o las teclas 'R' y 'F'). ¡Pruébalo!",
    "tutorial.tabersquare.step4": "El objetivo del juego es colocar todas las piezas dentro del tablero. Coloca la pieza que tienes seleccionada pinchando en una zona libre del tablero o arrastrándola.",
    "tutorial.tabersquare.finish": "¡Perfecto! Ya sabes cómo jugar. ¡Completa el tablero en el menor tiempo posible!",
    "tutorial.tabersquare.gotIt": "Entendido",
    "tutorial.tabersquare.playNow": "¡A jugar!",
    ...
    "e2.tutorial.interactive.step1": "¡Bienvenido a Taber's Eternity! Este es el tablero de juego. Tu objetivo es colocar todas las piezas haciendo coincidir sus bordes.",
    "e2.tutorial.interactive.step2": "Aquí tienes las piezas que debes colocar en el tablero. Se seleccionan con un clic y puedes rotarlas con el botón 'Rotar' o la tecla 'R'.",
    "e2.tutorial.interactive.step3": "¡Empieza por los bordes! Estas piezas tienen un borde gris (el exterior). Haz clic en una y colócala en una casilla vacía del borde del tablero.",
    "e2.tutorial.interactive.step4": "¡Muy bien! Ahora debes entender cómo funcionan las conexiones: cada pieza debe colocarse de forma que sus bordes adyacentes tengan el mismo color.",
    "e2.tutorial.interactive.step5": "¡Perfecto! Pulsa en cualquier casilla vacía para ver qué piezas encajan ahí (se resaltarán en verde). El objetivo es completar todo el tablero.",
  ...
  en: {
    ...
    "tutorial.tabersquare.step1": "Welcome to The Taber Square! This is the 6×6 game board with 7 blocked cells. Your goal is to place all the pieces into the remaining space.",
    "tutorial.tabersquare.step2": "These are the 9 pieces to place onto the board. Select them by clicking on them. Try selecting the red L piece!",
    "tutorial.tabersquare.step3": "You can rotate and flip the selected piece to fit it into the grid. Use the rotate and flip buttons (or 'R' and 'F' keys). Give it a try!",
    "tutorial.tabersquare.step4": "The objective of the game is to place all pieces inside the board. Place your selected piece by clicking on an empty cell or dragging it to the board.",
    "tutorial.tabersquare.finish": "Perfect! You're ready to play. Fill the board in the shortest time possible!",
    ...
    "e2.tutorial.interactive.step1": "Welcome to Taber's Eternity! This is the game board. Your goal is to place all the pieces so their edges match.",
    "e2.tutorial.interactive.step2": "Here are the pieces you need to place on the board. Click to select them, and use the 'Rotate' button or 'R' key to rotate.",
    "e2.tutorial.interactive.step3": "Start from the edges! These pieces have a grey border (the outer edge). Click one and place it on an empty border cell of the board.",
    "e2.tutorial.interactive.step4": "Great! Now you need to understand how connections work: each piece must be placed so its adjacent edges have the same color.",
    "e2.tutorial.interactive.step5": "Excellent! Tap any empty cell to see which pieces fit there (they will highlight in green). The goal is to complete the entire board!",
