...
const translations: Record<Lang, Dict> = {
  eu: {
    ...
    "home.card.study.tag": "Ikasketa · Kanpokoa",
    "home.card.study.desc": "Taberren ikasgela sekretua. Beste web batean ostatatuta dago — leiho berri batean irekiko da.",
    "home.external": "Kanpoan ireki",
  ...
  es: {
    ...
    "home.card.study.tag": "Estudio · Externo",
    "home.card.study.desc": "El estudio secreto de Taber. Alojado en otra web — se abrirá en una pestaña nueva.",
    "home.external": "Abrir fuera",
  ...
  en: {
    ...
    "home.card.study.tag": "Study · External",
    "home.card.study.desc": "Taber's secret study. Hosted on another site — opens in a new tab.",
    "home.external": "Open external",
    "home.locked": "Locked",
