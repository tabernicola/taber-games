...
export function SudokuBoard({
  ...
  const conflicts = useMemo(() => (grid.length === 81 ? sudokuConflicts(grid) : new Set<number>()), [grid]);
  ...
  return (
    <div className="murdoku-light min-h-screen">
      ...
      <main className="px-2 pb-32 pt-4">
        {!puzzle && <p className="py-20 text-center text-muted-foreground">{t("murdoku.generating")}</p>}
              ...
              {grid.map((value, index) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      borderRight: col % 3 === 2 && col !== 8 ? "2px solid #334155" : "1px solid #cbd5e1",
                      borderBottom: row % 3 === 2 && row !== 8 ? "2px solid #334155" : "1px solid #cbd5e1",
                    }}
