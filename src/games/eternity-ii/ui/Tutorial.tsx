...
import type { Placement, Rotation } from "../logic/game";
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      {highlightRects.length > 0 && (
        <svg aria-hidden className="fixed inset-0 h-full w-full" style={{ zIndex: 45 }}>
          <defs>
      ...
      <div className="absolute top-4 left-1/2 z-50 -translate-x-1/2 w-full max-w-md pointer-events-auto px-4">
        ...
        >
          ...
          {(currentStepData.action === "board" ||
            ...
            <button type="button" onClick={handleNextStep} className="e2-btn w-full">
              {t("tutorial.next")}
            </button>
          )}
          ...
          {isLastStep && (
            <div className="mt-3 space-y-2">
              ...
              <button type="button" onClick={handleClose} className="e2-btn w-full">
                {t("tutorial.close")}
              </button>
              {countdown !== null && (
