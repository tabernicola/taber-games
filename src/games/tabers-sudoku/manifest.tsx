  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex justify-center">
        <TabersSudokuLogo className="h-24 w-24" />
      </div>
      ...
      <p className="mt-3 text-sm text-muted-foreground flex-1">{t("home.card.sudoku.desc")}</p>
...
function TabersSudokuLogo({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 64 64"
...
export const tabersSudokuGame: GameModule = {
  id: "tabers-sudoku",
  Card,
  translations,
  createScoresService: () => createScoresService("scores_tabers_sudoku"),
